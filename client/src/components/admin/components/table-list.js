...
//   const rows = [
//     { id: 'first_name', numeric: false, disablePadding: true, label: 'Prenoms' },
//     { id: 'family_name', numeric: true, disablePadding: false, label: 'Nom de famille' },
//     { id: 'date_naissance', numeric: true, disablePadding: false, label: 'Fat (g)' },
//     { id: 'carbs', numeric: true, disablePadding: false, label: 'Carbs (g)' },
//     { id: 'protein', numeric: true, disablePadding: false, label: 'Protein' },
//   ];
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{n.date_of_birth}</TableCell>
